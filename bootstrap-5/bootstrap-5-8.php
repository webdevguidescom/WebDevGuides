...
$result = mysqli_query($con,"SELECT count FROM likes WHERE ID = 12");
$data = $result->fetch_all(MYSQLI_ASSOC);

$result2 = mysqli_query($con,"SELECT views FROM likes WHERE ID = 12");
$data2 = $result2->fetch_all(MYSQLI_ASSOC);


if(!isset($_COOKIE['not_unique12'])) {
    setcookie('not_unique12', '1', time() + (86400)); //30 days
    ...
    $sql = "UPDATE likes SET views = views + 1 WHERE ID = 12";
                    ...
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="bootstrap-5">
                      ...
                      <div class="parent-wrapper">
                        <ul class="nav collapse parent show" data-bs-parent="#bootstrap-5" id="bootstrap-5-2">
                          ...
                          <li class="nav-item"><a class="nav-link active" href="/bootstrap-5/bootstrap-5-8.php">
                ...
                <div class="card-body p-2 p-sm-2 p-lg-3">
                  ...
                  <header>
                    ...
                    <div class="float-end">
                      <nav aria-label="...">
                        <ul class="pagination justify-content-center">
                          ...
                          <li class="page-item active" aria-current="page">
                            <a class="page-link" href="/bootstrap-5/bootstrap-5-8.php">4 <span class="sr-only"></span></a>
                          </li>
                      ...
                      <h1 class="display-5">How to send the website files to Node.JS AWS web server</h1>
                      <p class="lead">Learn how to seamlessly transfer your website files to a Node.js AWS web server. This comprehensive guide covers everything from setting up your AWS environment to deploying your files using Node.js. Whether you’re a beginner or an experienced developer, this tutorial will help you efficiently manage your web server and ensure your website runs smoothly on AWS.</p>
...
xhttp.open("GET", "action-page-7.php?");
xhttp.send();
result.innerHTML = "Like successfully added";
              ...
              <div class="float-end">
                ...
                <hr class="hr" />
                      ...
                      <div class="container">
                        ...
                        <ol>
                          <li class="h5"><a href="#a1" style="color:teal;font-size: 16px;">How to send the website files to Node.JS AWS web server</a></li>
                        </ol>
                      </div>
...
<small class="d-inline-flex mb-3 px-2 py-1 fw-semibold text-info-emphasis bg-info-subtle border border-info-subtle rounded-2" style="font-size: 20px;">Using Phoenix v1.18</small>

                      <p>Now that we should have completed all of the previous steps. We can now send the files in the <mark>pheonix-v1.9.0/build/*</mark> directory the our AWS lightsail web server running Nginx</p>
                    <p> <a href="/aws/lamp-server.php" target="_blank" rel="noopener noreferrer" style="color:teal;">Here is a tutorial for setting up AWS web server</a>. You will need to off course choose Nginx instead of LAMP web server</p>
                    <hr class="hr" />
                    <p>Here is the command that I use to send the website files from my MacBook to my AWS Nginx web server:</p>
                    <br id="a1">
...
sudo scp -ri ~/Desktop/LightsailDefaultKey-eu-west-2-new.pem ~/Documents/build-csx-2-new/* bitnami@192.10.58.55:~/stack/nginx/html
                    ...
                    <p>So <mark>sudo</mark> is running the program as root/admin privaliges.</p>
                    <p><mark>scp</mark> is the program that we will be using to send the files to the server.</p>
                    <p><mark>-ri</mark> is the parameters that we will be using. The<strong>'r'</strong> parameter is tellng the program that we will be sending multiple files at once to the server. The <strong>'i'</strong> parameter is telling the scp program that we will be using a <strong>key file</strong> to authenticate ourselfs(instead of a password for eample)</p>
    
                    <p>The next part is saying where the key file is located. You will need to download your web server key file on your lightsail account</p>
                    <p>After that its saying what files we want to send. The <strong>*</strong> symbol indicates all= the files within that folder</p>
                    <p>bitnami will always be the user name and the ip address is the IP address of your Nginx web server. The <strong>:~/htdocs</strong> bit after the IP address, is locating where on the web server you would like your files to be placed. <strong>~/</strong> is shortcut for your home folder. <strong>htdocs</strong> is the folder where your website files will be served to the internet
                    </p>
              ...
              <div class="float-start">          <a href="/bootstrap-5/bootstrap-5-7.php" style="color:teal; font-size: 20px; " class="rounded float-left"><strong>Previous page:</strong> How to edit your Bootstrap 5 Pheonix template's HTML code in the 'build' directory</a>
              </div>
                ...
                <div class="d-lg-none"><!--hide on lg and wider screens-->
                  ...
                  <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                      ...
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-7.php">3</a></li>
                      <li class="page-item active" aria-current="page">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-6.php">4 <span class="sr-only"></span></a>
                      </li>
                ...
                <div class="d-none d-lg-block"><!--hide on screens smaller than lg-->
                  <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                      <li class="page-item">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-7.php" tabindex="-1" aria-disabled="true">Previous</a>
                      </li>
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-5.php">1</a></li>
