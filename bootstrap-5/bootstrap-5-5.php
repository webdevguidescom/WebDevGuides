...
$result = mysqli_query($con,"SELECT count FROM likes WHERE ID = 9");
$data = $result->fetch_all(MYSQLI_ASSOC);

$result2 = mysqli_query($con,"SELECT views FROM likes WHERE ID = 9");
$data2 = $result2->fetch_all(MYSQLI_ASSOC);


if(!isset($_COOKIE['not_unique9'])) {
    setcookie('not_unique9', '1', time() + (86400)); //30 days
    ...
    $sql = "UPDATE likes SET views = views + 1 WHERE ID = 9";
...
<html lang="en-US" dir="ltr" data-navigation-type="combo" data-navbar-horizontal-shape="slim">
  ...
  <head>
    ...
    <meta property="article:modified_time" content="2024-07-18T23:18:00+00:00">
    <meta name="description" content="Learn how to customize your Bootstrap 5 Phoenix template by editing SCSS and JavaScript variables in the ‘src’ directory. This guide walks you through the process of modifying theme colors, navigation widths, and more to tailor your admin dashboard to your specific needs. Perfect for developers looking to enhance their web applications with personalized styling and functionality.">

    <!-- ===============================================-->
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>How to Edit SCSS/JavaScript Variables in Your Bootstrap 5 Phoenix Template’s ‘src’ Directory | Computer Science X</title>
  ...
  <div class="parent-wrapper label-1">
    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="bootstrap-5">
      ...
      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#bootstrap-5-2" data-bs-toggle="collapse" aria-expanded="true" aria-controls="bootstrap-5-2">
        <div class="d-flex align-items-center">
      ...
      <!-- more inner pages-->
      <div class="parent-wrapper">
        <ul class="nav collapse parent show" data-bs-parent="#bootstrap-5" id="bootstrap-5-2">
          <li class="nav-item"><a class="nav-link active" href="/bootstrap-5/bootstrap-5-5.php">
      ...
      <div class="content">
          ...
          <div class="row g-4">
                      ...
                      <nav aria-label="...">
                        ...
                        <ul class="pagination justify-content-center">
                          ...
                          <li class="page-item active" aria-current="page">
                            <a class="page-link" href="/bootstrap-5/bootstrap-5-5.php">1<span class="sr-only"></span></a>
                          </li>
            
                          <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-6.php">2</a></li>
                          
                          <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-7.php">3</a></li>
      
                          <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-8.php">4</a></li>
            ...
            <h1 class="display-5">How to Edit SCSS/JavaScript Variables in Your Bootstrap 5 Phoenix Template’s ‘src’ Directory</h1>
            <p class="lead">Learn how to customize your Bootstrap 5 Phoenix template by editing SCSS and JavaScript variables in the ‘src’ directory. This guide walks you through the process of modifying theme colors, navigation widths, and more to tailor your admin dashboard to your specific needs. Perfect for developers looking to enhance their web applications with personalized styling and functionality.</p>
...
<h5 id="GFG"></h5>
              ...
              <div class="float-end">
                ...
                <hr class="hr" />
                      ...
                      <div class="container">
                        ...
                        <ol>
                          <li class="h5"><a href="#a1" style="color:teal;font-size: 16px;">What are the 'src' and 'public' files used for?</a></li>
                          <li class="h5"><a href="#a2" style="color:teal;font-size: 16px;">Javscript example</a></li>
                          <li class="h5"><a href="#a3" style="color:teal;font-size: 16px;">SCSS example</a></li>
                        </ol>
                      </div>
  ...
  <small class="d-inline-flex mb-3 px-2 py-1 fw-semibold text-info-emphasis bg-info-subtle border border-info-subtle rounded-2" style="font-size: 18px;">Using Phoenix v1.18</small>
                      ...
                      <p><a href="https://themes.getbootstrap.com/product/phoenix-admin-dashboard-webapp-template/" target="_blank" rel="noopener noreferrer" style="color:teal;">themes.getbootstrap.com/phoenix</a> - You can buy the Phoenix theme from the Bootstrap website or directly from <a href="https://themewagon.com/" target="_blank" rel="noopener noreferrer" style="color:teal;">themewagon.com</a> (the creators of this theme). Theme Wagon also offers free Bootstrap 5 templates.
                        Setting Up Your Template</p>

                      <p>After purchasing and downloading your template, unzip/unpack the files. Your folder structure should look like this:</p>
             
  
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/3/sys3-1.png">
  
                      <br id="a1">
                      <hr class="hr" />
                      <h2>What are the 'src' and 'public' folders used for?</h2>

                      <p>The <strong>'src'</strong> folder contains the Javascript and CSS code that you can edit.</p>
  
                      <p>The <strong>'public'</strong> folder contains the HTML template files.</p>
  
                      <br id="a2">
                      <hr class="hr" />
                      <h2>Javascript variables</h2>
                      <p>As an example, I will show you the config.js file (located in the directory <mark>phoenix-v1.9.0/src/js/config.js</mark>):</p>
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/3/sys3-2.png">
                      <p>Circled in <strong style="color:red;">RED</strong> is variable for the initial light/dark configuration. So if you changed the value circled in <strong style="color:red;">RED</strong> to 'dark' instead of 'light'. When the user opens your web page. They will automatically have the dark theme.</p>
                      ...
                      <p>Here are some useful SCSS variables located in the folder <mark>pheonix-v1.9.0/src/scss/theme/_variables.scss</mark></p>
  
                      <img class="ratio ratio-16x9" src="/assets/img/bootstrap/1/boot1-1.png">
                      <p>Changing these 2 variables cicled above(in <strong style="color:green;">GREEN</strong>) to the color "teal". Will change the color of the pagination items(like shown bellow)</p>
                      <img class="ratio ratio-16x9" src="/assets/img/bootstrap/1/boot1-3.png">
<br>
                      <img class="ratio ratio-16x9" src="/assets/img/bootstrap/1/boot1-4.png">
                      <p>We can also add our own custom SCSS variables(as shown above in <strong style="color:green;">GREEN</strong>) as show on the pagination page on Bootstrap 5.3 documentation. I have added these variables which seem to work well changing them to my website color teal</p>
                      <br>
                      <img class="ratio ratio-16x9" src="/assets/img/bootstrap/1/boot1-5.png">

                      <p>We can also change these 2 variables (as shown above in <strong style="color:green;">GREEN</strong>) to the color teal. This will chnage the color when hovering over a sidnav item link.</p>
  
                      <br>
                      <p>Changing the vertical nav variable(circled in <strong style="color:green;">GREEN</strong> bellow) to make it a little bit wider. So that we can fit more text for each navigation item. Like shown bellow:</p>
  
                      <img class="ratio ratio-16x9" src="/assets/img/bootstrap/1/boot1-2.png">
  
                      <hr class="hr" />
  
                      <p>Now that we have edited our Javascript and SCSS variables. We can now <a href="/bootstrap-5/bootstrap-5-6.php" target="_blank" rel="noopener noreferrer" style="color:teal;">build our code</a> to compile the SCSS and Javascript files into our HTML files that we can edit</p>         
  
                       <hr class="hr" />
  
  
                      <p><strong>Please note that after we have built our code, we will not be able to edit these variables again unless we go back into the 'src' folder and complete the process again.</strong></p>
              ...
              <div class="float-end">          <a href="/bootstrap-5/bootstrap-5-6.php" style="color:teal; font-size: 20px; " class="rounded float-right"><strong>Next page:</strong> Building the code with npm</a>
                ...
                <div class="d-lg-none"><!--hide on lg and wider screens-->
                  ...
                  <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                      <li class="page-item active" aria-current="page"><a class="page-link" href="/bootstrap-5/bootstrap-5-5.php">1 <span class="sr-only"></span></a></li>
                      
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-6.php">2</a></li>
                      <li class="page-item">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-7.php">3</span></a>
                      </li>
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-8.php">4</a></li>
                      </li>
                ...
                <div class="d-none d-lg-block"><!--hide on screens smaller than lg-->
                  ...
                  <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                      ...
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-8.php">4</a></li>
                      <li class="page-item">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-6.php">Next</a>
                      </li>
                    </ul>
                  </nav>
    ...
    <div class="card-body">
      ...
      <div class="avatar avatar-5xl">
        ...
        <p style="font-size: 13px;" >Date Published <span class="fw-semi-bold text-primary">  <time itemprop="datePublished" datetime="2023-06-20T12:00:00Z">20 Jun 2023</time></span>
          <br>Date Modified <span class="fw-semi-bold text-primary">  <time itemprop="dateModified" datetime="2024-07-18T18:00:00Z">18 Jul 2024</time></span>
