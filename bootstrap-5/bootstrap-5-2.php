...
$result = mysqli_query($con,"SELECT count FROM likes WHERE ID = 7");
$data = $result->fetch_all(MYSQLI_ASSOC);

$result2 = mysqli_query($con,"SELECT views FROM likes WHERE ID = 7");
$data2 = $result2->fetch_all(MYSQLI_ASSOC);


if(!isset($_COOKIE['not_unique7'])) {
    setcookie('not_unique7', '1', time() + (86400)); //30 days
    ...
    $sql = "UPDATE likes SET views = views + 1 WHERE ID = 7";
...
<html lang="en-US" dir="ltr" data-navigation-type="combo" data-navbar-horizontal-shape="slim">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>How to use HTML partials - Bootstrap 5 Dashly dashboard template for Node.JS | Computer Science X</title>
    ...
    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="bootstrap-5">
      ...
      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#bootstrap-5-1" data-bs-toggle="collapse" aria-expanded="true" aria-controls="bootstrap-5-1">
        ...
        <div class="parent-wrapper">
          <ul class="nav collapse parent show" data-bs-parent="#bootstrap-5" id="bootstrap-5-1">
            ...
            <li class="nav-item"><a class="nav-link active" href="/bootstrap-5/bootstrap-5-2.php">
      ...
      <div class="content">
          ...
          <div class="row g-4">
            ...
            <h1 class="display-5">How to use HTML partials - Bootstrap 5 Dashly dashboard template for Node.JS</h1>
            <p class="lead"></p>
...
xhttp.open("GET", "action-page-2.php?");
xhttp.send();
result.innerHTML = "Like successfully added";
...
<h5 id="GFG"></h5>
            ...
            <div class="d-lg-none"><!--hide on lg and wider screens-->
              ...
              <div class="float-end">
                <nav aria-label="...">
                  ...
                  <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item active" aria-current="page">
                      <a class="page-link" href="/bootstrap-5/bootstrap-5-2.php">2<span class="sr-only"></span></a>
                    </li>
                ...
                <hr class="hr" />
                      ...
                      <h2>How to use HTML partials</h2>
                      <br>
                      <h3>What are HTML partials in Node.JS?</h3>
                      <br>
                      <p>Partials are basically HTML code that is going to be reused a lot. It makes it so you don't have to keep copy and pasting specific sections of code onto every HTML web page. So the <strong>head</strong> section has its own partial file. The <strong>sidenav, heading, footer</strong> etc. has their own partial file. When we <strong>build</strong> our website code. It will automatically add the partials to our HTML code for each web page. We can also pass in values to out partials, as shown below:</p>
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys6.png">
                      <p><strong>I have circled in RED the HTML partials in the index.php file</strong></p>
                      <br><br>
                      
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys5.png">
                      <p>This partial file is for the sidenav. Like I said, this section of HTML would usually be added to the code of separate web pages. Meaning that if we wanted to add/edit/remove a section of our sidenav, we would usually have to edit the code on each individual web page. with partials, we would only have to edit the sidenav partial file, and then when we build our code. It will have added it automatically to our individual web pages that will be placed in the dist folder.</p>
              ...
              <div class="float-start">          <a href="/bootstrap-5/bootstrap-5-1.php" style="color:teal; font-size: 20px; " class="rounded float-left"><strong>Previous page:</strong> How to build (with NPM) your Bootstrap 5 Dashly template's code for Node.JS</a>
              </div>
                <div class="float-end">          <a href="/bootstrap-5/bootstrap-5-3.php" style="color:teal; font-size: 20px; " class="rounded float-right"><strong>Next page:</strong> How to edit your Bootstrap 5 Dashly template's HTML code for Node.JS</a>
                ...
                <div class="d-none d-lg-block"><!--hide on screens smaller than lg-->
                  ...
                  <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                      <li class="page-item">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-1.php" tabindex="-1" aria-disabled="true">Previous</a>
                      </li>
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-1.php">1</a></li>
                      <li class="page-item active" aria-current="page">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-2.php">2 <span class="sr-only"></span></a>
                      ...
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-3.php">3</a></li>
                      <li class="page-item">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-3.php">Next</a>
                      </li>
                    </ul>
                  </nav>
