...
$result = mysqli_query($con,"SELECT count FROM likes WHERE ID = 8");
$data = $result->fetch_all(MYSQLI_ASSOC);

$result2 = mysqli_query($con,"SELECT views FROM likes WHERE ID = 8");
$data2 = $result2->fetch_all(MYSQLI_ASSOC);


if(!isset($_COOKIE['not_unique8'])) {
    setcookie('not_unique8', '1', time() + (86400)); //30 days
    ...
    $sql = "UPDATE likes SET views = views + 1 WHERE ID = 8";
...
<html lang="en-US" dir="ltr" data-navigation-type="combo" data-navbar-horizontal-shape="slim">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>How to edit your Bootstrap 5 Dashly template's HTML code for Node.JS | Computer Science X</title>
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <hr class="navbar-vertical-line" />
                ...
                <hr class="navbar-vertical-line" />
  <!-- parent pages-->
  <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#bootstrap-5" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="bootstrap-5">
  ...
  <div class="parent-wrapper label-1">
    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="bootstrap-5">
      <li class="collapsed-nav-item-title d-none">Bootstrap 5 Theme's
      </li>



      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#bootstrap-5-1" data-bs-toggle="collapse" aria-expanded="true" aria-controls="bootstrap-5-1">
          <div class="d-flex align-items-center">
        ...
        <div class="parent-wrapper">
          <ul class="nav collapse parent show" data-bs-parent="#bootstrap-5" id="bootstrap-5-1">
            ...
            <li class="nav-item"><a class="nav-link active" href="/bootstrap-5/bootstrap-5-3.php">
      ...
      <div class="content">
          ...
          <div class="row g-4">
                    ...
                    <div class="float-end">
                      <nav aria-label="...">
                        ...
                        <ul class="pagination justify-content-center">
                          ...
                          <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-1.php">1</a></li>
                    
                          <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-2.php">2</a></li>
                          <li class="page-item active" aria-current="page">
                            <a class="page-link" href="/bootstrap-5/bootstrap-5-3.php">3<span class="sr-only"></span></a>
                          </li>
            ...
            <h1 class="display-5">How to edit your Bootstrap 5 Dashly template's HTML code for Node.JS</h1>
            <p class="lead"></p>
...
xhttp.open("GET", "action-page-3.php?");
xhttp.send();
result.innerHTML = "Like successfully added";
              ...
              <div class="float-end">
                ...
                <hr class="hr" />
                      ...
                      <div class="container">
                        ...
                        <ol>
                          <li class="h5"><a href="#a1" style="color:teal;font-size: 16px;">Building our code and viewing our webpage through the command line</a></li>
                        </ol>
                      </div>
                  ...
                  <p>So when you have purchased and downloaded your template, you will need to unzip/unpack the files. Then your folder structure should be something like this:</p>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys3.png">
                  <p>For this dashly template example. We will only be using the theme directory(folder) within the dashly directory. This theme folder holds all of our website files (HTML, CSS, Javascript etc.).</p>
                  <p>So the <strong>src</strong> folder inside the theme directory is where our website files and folders will be edited from.</p>
                  <br><br>
                  <hr class="hr" />
                  <p>So first thing I would do is go into the <strong>dashly/theme/src/html</strong> folder and create a new folder called templates. Then put all of the <strong>.php</strong> files into this folder.</p>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys10.png">
                  <p>We can then take out the HTML files that we want to use (like shown below):</p>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys4.png">
                  <br><br><br>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys11.png">
                  <p>As you can see (circled in RED), I have taken the <strong>index.php</strong> page out of the templates folder that I created. We can now edit this page to our desire. I would recommend creating some of your own templates. For example, if you had a blog website. You could create a template specifically for blog posts and then just copy and paste the page when a new template is needed.</p>
                  <br>
                  <p>Now lets start off by editing the code of the <strong>sidenav.php</strong> partials file <strong>(if you dont know how HTML partials work <a href="/bootstrap-5/bootstrap-5-2.php#a2" target="_blank" rel="noopener noreferrer" style="color:teal;">Check out my expenation here</a></strong>)</p>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys12.png">
                  <p>Editing this partials file, will change the code of the sidenav.</p>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys13.png">
                  <p>Here is what our template looks like at the moment. Circled in RED is the sidenav, that we are editing.</p>
                  <p>So, we want to have our own navigation items in this sidebar. We can basically delete all of these items. You will want to leave 1 or more of these items to use as a template for your own items.</p>
                  <p>As we can see in the screenshot above, the 'components' link is the last item on the sidebar. So lets go down to where 'components' is in our code and then we can delete up from there like shown below: <strong>Make sure not to delete any closing tags that is part of the structure of the sidenav.</strong></p>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys14.png">
                  <p>We will be deleting a large portion of code from this point up till near the top. <strong>Remembering to leave 1 or more items as templates for our own links.</strong></p>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys15.png">
                  <p>Lets drag our cursor up to the 'Pages' section, as this is them second to last item. <strong>Leaving the 'Dashboard' dropdown links as out template.</strong></p>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys16.png">
                  <br><br><br>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys17.png">
                  <p>Lets also delete this section as its just an advertisment for a premium feature of this template.</p>
                  <br id="a1"><br>
                  <hr class="hr" />
                  <h2>Building our code and viewing our webpage through the command line</h2>
                  <br>
                  <p>First go to your command prompt on Mac or Linux. Go to your dashly tempalates main directory(with the package.json file/s) Run the command:</p>
                  <pre>
                    <code>
cd ~/Documents/dashly/theme
                    </code>
                  </pre>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys22.png">
                  <p>As my dashly theme is in the ~/Documents directory (<strong>'~/'</strong> is shorcut for the home directory).</p>
                  <br>
...
npm run build
                  ...
                  <p><strong>Note: if you dont have npm installed<a href="https://docs.npmjs.com/downloading-and-installing-node-js-and-npm" target="_blank" rel="noopener noreferrer" style="color:teal;"> You can go here to find out how to install on your operating system</a></strong></p>
    
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys18.png">
                  <p>After the <strong>Build</strong> process is finished. It will have created a new folder in the <strong>theme (main) directory</strong> called <strong>'dist'</strong>. The files in the dist fodler, will be the files that we will be sending to our web server for deployment.</p>
                  <p>So when we build our code. This basically adds all of our partials, Javscript, CSS etc. files automatically to our induvidual web pages. So when we want to change our sidenav. We can just go into the sidenav partials file in the <strong>'src'</strong> directory. Edit the code just once, and then when we <strong>build</strong> our code. It will have automatically added our sidenav to each html web page. Basically just saving us from copy and pasting and editing each induvidual web page. Which is just time consuming and could also cause errors from missplacing code.</p>
          
                  <br>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys19.png">
                  <p>As you can see the build process is finished.</p>
                  <br>
...
npm run start
                  ...
                  <p>This will then basically start our web server from the terminal and open up a window in your default browser displaying your web page from the <strong>'dist'</strong> folder.</p>
                  <p><strong>Note: if we keep this web page open and edit our html code in the dist directory. As soon as we save our file, it will automatically refresh our web page that we have running on 'localhost'. This is useful for editing our code live and not having to upload to the server everytime we want to view an edit of our code.</strong></p>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys20.png">

                  <p>Running <strong>npm run start</strong> from the command line will then open up our web page like shown below:</p>

                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys21.png">
                  <p>Circled in RED is our sidenav code that we editied.</p>
                  <br>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys23.png">
                  <p>Next thing I would edit on your sidenav is the sections circled above. These names basically control the dropdown behaviour your sidenav links. <strong>Note: You will need to call these different names for each sidenav link item. As if they are called the same names, when you click on a dropdown item it will dropdown all of the sidenav links with that same name.</strong> Just find the 'id', 'href', that have the same name or same name with 'Collapse' added. And then change these values to your own unique name. <strong>Note: There is also a couple more values with the same name and value to the right (couldnt fit in the screenshot).</strong> Just make sure these all match for this specific dropdown item.</p>
                  <br>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys24.png">
                  <p>Now in our sidenav.php partials file. Add the path to the html pages required (circled in RED).</p>
                  <p>Add the name of the file for that page in the part cirled in BLUE. This is the html page it will be opening. This will basically make it so that when we view that page it will keep that dropdown link open and the link for the page will be highlighted (so we know which page we are viewing).</p>
                  <br>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys25.png">
                  <p>Now lets add an icon to this dropdown item. <a href="https://icons.getbootstrap.com/" target="_blank" rel="noopener noreferrer" style="color:teal;"> Bootstrap 5 Icons</a> - You can get the <strong>svg</strong> code for Bootstrap 5 icons here.</p>
                  <p>Copy the <strogn>svg</strogn> code (circled in RED above), and paste it into your sidenav item like shown below:</p>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys26.png">
                  <p>Replace the code between the opening and closing <strong>svg</strong> tags for your own.</p>
                  <p>Then when we save and go back to our localhost server in our browser it should look something like this:</p>
                  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys27.png">
                  <p>As you can see, its added our own icon (circled in RED).</p>
                  <p>You can chnage the size and stuff by just playing around with it and changing values and seeing what happens basically.</p>
              ...
              <div class="float-start">          <a href="/bootstrap-5/bootstrap-5-2.php" style="color:teal; font-size: 20px; " class="rounded float-left"><strong>Previous page:</strong> How to use HTML partials in Node.JS</a>
              </div>
                ...
                <div class="d-none d-lg-block"><!--hide on screens smaller than lg-->
                  ...
                  <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                      <li class="page-item">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-2.php" tabindex="-1" aria-disabled="true">Previous</a>
                      </li>
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-1.php">1</a></li>
