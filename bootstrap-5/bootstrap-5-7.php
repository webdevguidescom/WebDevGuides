...
$result = mysqli_query($con,"SELECT count FROM likes WHERE ID = 11");
$data = $result->fetch_all(MYSQLI_ASSOC);

$result2 = mysqli_query($con,"SELECT views FROM likes WHERE ID = 11");
$data2 = $result2->fetch_all(MYSQLI_ASSOC);


if(!isset($_COOKIE['not_unique11'])) {
    setcookie('not_unique11', '1', time() + (86400)); //30 days
    ...
    $sql = "UPDATE likes SET views = views + 1 WHERE ID = 11";
...
<html lang="en-US" dir="ltr" data-navigation-type="combo" data-navbar-horizontal-shape="slim">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>In this comprehensive guide, you’ll learn step-by-step techniques to customize your template’s HTML code, ensuring your web project stands out. | Computer Science X</title>
    ...
    <main class="main" id="top">
                    ...
                    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="bootstrap-5">
                      ...
                      <div class="parent-wrapper">
                        <ul class="nav collapse parent show" data-bs-parent="#bootstrap-5" id="bootstrap-5-2">
                          ...
                          <li class="nav-item"><a class="nav-link active" href="/bootstrap-5/bootstrap-5-7.php">
      ...
      <div class="content">
          ...
          <div class="row g-4">
                      ...
                      <nav aria-label="...">
                        ...
                        <ul class="pagination justify-content-center">
                          ...
                          <li class="page-item active" aria-current="page">
                            <a class="page-link" href="/bootstrap-5/bootstrap-5-7.php">3<span class="sr-only"></span></a>
                          </li>
            ...
            <h1 class="display-5">How to Edit Your Bootstrap 5 Phoenix Template’s HTML Code</h1>
            <p class="lead">In this comprehensive guide, you’ll learn step-by-step techniques to customize your template’s HTML code, ensuring your web project stands out.</p>
              ...
              <div class="float-end">
                ...
                <hr class="hr" />
                      ...
                      <div class="container">
                        ...
                        <ol>
                          <li class="h5"><a href="#a1" style="color:teal;font-size: 16px;">Editing the sidenav</a></li>
                        </ol>
                      </div>
...
<small class="d-inline-flex mb-3 px-2 py-1 fw-semibold text-info-emphasis bg-info-subtle border border-info-subtle rounded-2" style="font-size: 20px;">Using Phoenix v1.9(OLD VERION)</small>

                      <p>Once we have <strong><a href="/bootstrap-5/bootstrap-5-6.php" target="_blank" rel="noopener noreferrer" style="color:teal;">built</a></strong> our code in the terminal. We can now edit these HTML files in the <strong>build</strong> directory. Like shown bellow:</p>
                    
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/3/sys3-7.png">
                      <hr class="hr" />
  
                      <p>Lets start off by opening the Pheonix theme on our computer.</p>
  
                      
                      <br id="a1"><br>
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/3/sys3-10.png">
  
                      <p>Circled in <strong style="color:red;">RED</strong> is the sidnav that we are going to edit first.</p>
  
                      <p>Open the file <mark>phoenix-v1.9.0/build/index.php</mark> in you HTML/text editor(<a href="https://code.visualstudio.com/" target="_blank" rel="noopener noreferrer" style="color:teal;">Visual Studio Code</a> is the best and most popular code editor).</p>
  
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/3/sys3-11.png">
                      <br>
  
                      <p>Lets start off by getting rid of all of the nav items in the sidebar(<strong>leaving at least 1 items code to use as a template</strong>).</p>
  
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/3/sys3-12.png">
  
                      <p>We will keep the <strong>Home</strong> section of code to use as a template and delete all the sidenav items bellow this(arrowed in <strong style="color:green;">GREEN</strong>).</p>
  
                   
  
                      <p>I have highlighted and deleted the code from line <mark>104</mark> to line <mark>1101</mark>(like shown in the screen shot bellow</p>
  
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/3/sys3-13.png">
              ...
              <div class="float-start">          <a href="/bootstrap-5/bootstrap-5-6.php" style="color:teal; font-size: 20px; " class="rounded float-left"><strong>Previous page:</strong> How to build your Bootstrap 5 Pheonix template in your terminal with NPM</a>
              </div>
              <div class="float-end">          <a href="/bootstrap-5/bootstrap-5-8.php" style="color:teal; font-size: 20px; " class="rounded float-right"><strong>Next page:</strong> Command to send files to web server</a>
                ...
                <div class="d-none d-lg-block"><!--hide on screens smaller than lg-->
                  ...
                  <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                      <li class="page-item">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-6.php" tabindex="-1" aria-disabled="true">Previous</a>
                      </li>
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-5.php">1</a></li>
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-6.php">2</a></li>
                      <li class="page-item active" aria-current="page">
                      ...
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-8.php">4</a></li>
                      <li class="page-item">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-8.php">Next</a>
                      </li>
                    </ul>
                  </nav>
