...
$result = mysqli_query($con,"SELECT count FROM likes WHERE ID = 10");
$data = $result->fetch_all(MYSQLI_ASSOC);

$result2 = mysqli_query($con,"SELECT views FROM likes WHERE ID = 10");
$data2 = $result2->fetch_all(MYSQLI_ASSOC);


if(!isset($_COOKIE['not_unique10'])) {
    setcookie('not_unique10', '1', time() + (86400)); //30 days
    ...
    $sql = "UPDATE likes SET views = views + 1 WHERE ID = 10";
...
<html lang="en-US" dir="ltr" data-navigation-type="combo" data-navbar-horizontal-shape="slim">
  ...
  <head>
    ...
    <meta name="description" content="Discover how to efficiently build your Bootstrap 5 Phoenix template directly in your terminal using NPM. This tutorial covers the essential steps, from setting up your environment to running build commands, ensuring a smooth and streamlined development process. Perfect for developers aiming to enhance their workflow and leverage the full potential of Bootstrap 5 and NPM.">

    <!-- ===============================================-->
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>How to Build Your Bootstrap 5 Phoenix Template in Your Terminal with NPM | Computer Science X</title>
    ...
    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="bootstrap-5">
      ...
      <div class="parent-wrapper">
        <ul class="nav collapse parent show" data-bs-parent="#bootstrap-5" id="bootstrap-5-2">
          ...
          <li class="nav-item"><a class="nav-link active" href="/bootstrap-5/bootstrap-5-6.php">
      ...
      <div class="content">
          ...
          <div class="row g-4">
                    ...
                    <div class="float-end">
                      <nav aria-label="...">
                        ...
                        <ul class="pagination justify-content-center">
                          ...
                          <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-5.php">1</a></li>
                          <li class="page-item active" aria-current="page">
                            <a class="page-link" href="/bootstrap-5/bootstrap-5-6.php">2 <span class="sr-only"></span></a>
                          </li>
            ...
            <h1 class="display-5">How to Build Your Bootstrap 5 Phoenix Template in Your Terminal with NPM</h1>
            <p class="lead">Discover how to efficiently build your Bootstrap 5 Phoenix template directly in your terminal using NPM. This tutorial covers the essential steps, from setting up your environment to running build commands, ensuring a smooth and streamlined development process. Perfect for developers aiming to enhance their workflow and leverage the full potential of Bootstrap 5 and NPM.</p>
...
xhttp.open("GET", "action-page-5.php?");
xhttp.send();
result.innerHTML = "Like successfully added";
              ...
              <div class="float-end">
                ...
                <hr class="hr" />
                      ...
                      <div class="container">
                        ...
                        <ol>
                          <li class="h5"><a href="#a1" style="color:teal;font-size: 16px;">Building the code</a></li>
                        </ol>
                      </div>
...
<small class="d-inline-flex mb-3 px-2 py-1 fw-semibold text-info-emphasis bg-info-subtle border border-info-subtle rounded-2" style="font-size: 20px;">Using Phoenix v1.18(UDATED/NEW VERSION)</small>



<p>Once you have edited the <a href="/bootstrap-5/bootstrap-5-5.php" target="_blank" rel="noopener noreferrer" style="color:teal;">Javascript and SCSS variables</a> in the <strong>'src'</strong> folder. We will need to <strong>build</strong> the code so that its ready to edit the HTML.</p>
<br id="a1"><br>
<hr class="hr" />
<h2>Building our code</h2>
<p>If you’re not familiar with the process of <strong>building</strong> your code in Node.js, here’s a brief explanation:</p>
<ol style="font-size: 20px;">
  <li>Edit the Files: Edit the files in the src directory. If you’re unsure how to do this, here is a tutorial for editing the <a href="/bootstrap-5/bootstrap-5-5.php" target="_blank" rel="noopener noreferrer" style="color:teal;">Javascript and SCSS variables</a>. Note that we will not be sending these files in the src folder to our web server, as they have not been ‘built’ (i.e., prepared for use on web servers).</li>
  <br>
  <li>Navigate to the Theme’s Main Directory: Open your command prompt and navigate to the theme’s main directory (e.g., <mark>cd ~/Documents/phoenix-v1.9.0)</mark>. This directory contains the package.json file(s).</li>
  <img class="ratio ratio-16x9" src="/assets/img/sys-admin/3/sys3-4.png">
  <br><br>
  <li>Install Dependencies: Run the command <mark>sudo npm i</mark>. This will download the package dependencies and compile the SCSS/JavaScript files into your website files, placing your website code in the newly created public folder. The dependencies are listed in the package.json file.</li>
  <br><br>
  <li>Run Gulp: Run the command <mark>sudo gulp</mark>. This will open a local host on your default browser. You can now edit the HTML code in the public folder, and your updates will be shown live on that local host terminal connection.</li>
  <br><br>
</ol>
<br>
<hr class="hr" />
              ...
              <div class="float-start">          <a href="/bootstrap-5/bootstrap-5-5.php" style="color:teal; font-size: 20px; " class="rounded float-left"><strong>Previous page:</strong> How to edit your Bootstrap 5 Pheonix template's SCSS/Javscript variables in the 'src' directory</a>
              </div>
              <div class="float-end">          <a href="/bootstrap-5/bootstrap-5-7.php" style="color:teal; font-size: 20px; " class="rounded float-right"><strong>Next page:</strong> How to edit your Bootstrap 5 Pheonix template's HTML code in the 'build' directory</a>
                ...
                <div class="d-none d-lg-block"><!--hide on screens smaller than lg-->
                  ...
                  <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                      <li class="page-item">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-5.php" tabindex="-1" aria-disabled="true">Previous</a>
                      </li>
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-5.php">1</a></li>
                      <li class="page-item active" aria-current="page">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-6.php">2 <span class="sr-only"></span></a>
                      ...
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-8.php">4</a></li>
                      <li class="page-item">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-7.php">Next</a>
                      </li>
                    </ul>
                  </nav>
