...
$result = mysqli_query($con,"SELECT count FROM likes WHERE ID = 6");
$data = $result->fetch_all(MYSQLI_ASSOC);

$result2 = mysqli_query($con,"SELECT views FROM likes WHERE ID = 6");
$data2 = $result2->fetch_all(MYSQLI_ASSOC);


if(!isset($_COOKIE['not_unique6'])) {
    setcookie('not_unique6', '1', time() + (86400)); //30 days
    ...
    $sql = "UPDATE likes SET views = views + 1 WHERE ID = 6";
...
<html lang="en-US" dir="ltr" data-navigation-type="combo" data-navbar-horizontal-shape="slim">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>How to build (with NPM) your Bootstrap 5 Dashly template's code for Node.JS | Computer Science X</title>
    ...
    <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="bootstrap-5">
      ...
      <li class="nav-item"><a class="nav-link dropdown-indicator" href="#bootstrap-5-1" data-bs-toggle="collapse" aria-expanded="true" aria-controls="bootstrap-5-1">
        ...
        <div class="parent-wrapper">
          <ul class="nav collapse parent show" data-bs-parent="#bootstrap-5" id="bootstrap-5-1">
            <li class="nav-item"><a class="nav-link active" href="/bootstrap-5/bootstrap-5-1.php">
      ...
      <div class="content">
          ...
          <div class="row g-4">
            ...
            <h1 class="display-5">How to build (with NPM) your Bootstrap 5 Dashly template's code for Node.JS</h1>
            <p class="lead"></p>
...
xhttp.open("GET", "action-page-1.php?");
xhttp.send();
result.innerHTML = "Like successfully added";
...
<h5 id="GFG"></h5>
            ...
            <div class="d-lg-none"><!--hide on lg and wider screens-->
              ...
              <div class="float-end">
                <nav aria-label="...">
                  ...
                  <ul class="pagination justify-content-center">
                    ...
                    <li class="page-item active" aria-current="page">
                      <a class="page-link" href="/bootstrap-5/bootstrap-5-1.php">1<span class="sr-only"></span></a>
                    </li>
                    <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-2.php">2</a></li>

                    
                    <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-3.php">3</a></li>
                ...
                <hr class="hr" />
                      ...
                      <p>On this page I will be teaching you how to edit the HTML/CSS of your Bootstrap 5 theme.</p>
                      <p><a href="https://themes.getbootstrap.com" target="_blank" rel="noopener noreferrer" style="color:teal;">themes.getbootstrap.com</a> - You can buy a $50 Bootstrap theme here.
                      </p>
                      <p>I will be using the dashly template for this example.</p>
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys1.png">
                      <br id="a1"><br>
                      
                      <hr class="hr" />
                      <h2>Building our HTML code</h2>
                      <p>If your not familiar with the process of <strong>building</strong> your code in Node.JS, I will explain it briefly here:</p>
                      <ol style="font-size: 20px;">
                        <li>Edit the HTML, CSS, Javascript etc. files in the <strong>src</strong> directory(if your not sure how to <a href="/bootstrap-5/bootstrap-5-23.php" target="_blank" rel="noopener noreferrer" style="color:teal;">Here is a tutorial for editing the HTML of Bootstrap 5 Template</a>). <strong>Please note that we will not be sending these files in the 'src' folder to our web server, as these have not been 'built' (basically building our code for use on web servers)</strong></li>
                        <br>
                        <li>Go to the theme's main directory on your command prompt (for example, <strong>cd ~/Documents/dashly/theme</strong>). If you are using another bootstrap 5 template, go to the main directory that has the package.json file/s in.</li>
                        <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys9.png">
                        <br><br>
                        <li>Run the command <strong>npm install</strong>. This will then <strong>Download your theme's dependancies</strong>(basically, files that the theme needs to function). <strong>The dependencies are listed in the package.json file.</strong></li>
                        <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys7.png">
                        <br><br>
                        <li>Run the command <strong>npm run build</strong>. This will then <strong>build</strong> your code and place your website files in a new directory. It will create a directory called <strong>dist</strong> in your theme directory.</li>
                        <img class="ratio ratio-16x9" src="/assets/img/sys-admin/1/sys8.png">
                        <br><br>
                        <li>Now these folders inside the dist directory are the files/folders that we will be sending to our web server for deployment.</li>
                      </ol>
                      <br>
              ...
              <div class="float-end">          <a href="/bootstrap-5/bootstrap-5-2.php" style="color:teal; font-size: 20px; " class="rounded float-right"><strong>Next page: </strong>How to use HTML partials in Node.JS</a>
                ...
                <div class="d-none d-lg-block"><!--hide on screens smaller than lg-->
                  ...
                  <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                      ...
                      <li class="page-item"><a class="page-link" href="/bootstrap-5/bootstrap-5-3.php">3</a></li>
                      <li class="page-item">
                        <a class="page-link" href="/bootstrap-5/bootstrap-5-2.php">Next</a>
                      </li>
                    </ul>
                  </nav>
