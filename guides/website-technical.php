...
$result = mysqli_query($con,"SELECT count FROM likes WHERE ID = 14");
$data = $result->fetch_all(MYSQLI_ASSOC);

$result2 = mysqli_query($con,"SELECT views FROM likes WHERE ID = 14");
$data2 = $result2->fetch_all(MYSQLI_ASSOC);


if(!isset($_COOKIE['not_unique14'])) {
    setcookie('not_unique14', '1', time() + (86400)); //30 days
    ...
    $sql = "UPDATE likes SET views = views + 1 WHERE ID = 14";
...
<html lang="en-US" dir="ltr" data-navigation-type="combo" data-navbar-horizontal-shape="slim">
  ...
  <head>
    ...
    <meta property="article:published_time" content="2024-09-03T23:18:00+00:00">
    <meta property="article:modified_time" content="2024-09-03T23:18:00+00:00">
    <meta name="description" content="In this guide, we’ll walk you through the process of creating a website from scratch and deploying it to an AWS web server.">

    <!-- ===============================================-->
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>How to Build a Website Using Code: A Technical Guide | Computer Science X</title>
              ...
              <div class="card">
                ...
                <div class="card-body p-2 p-sm-2 p-lg-3">
                  ...
                  <header>
                    ...
                    <h1 class="display-5">How to Build a Website Using Code: A Technical Guide</h1>
                    <p class="lead">In this guide, i'll walk you through the process of creating a website from scratch and deploying it to an AWS web server.</p>
...
<h5 id="GFG"></h5>
                    ...
                    <div class="container">
                      ...
                      <ol>
                        <li class="h5"><a href="#a1" style="color:teal;font-size: 16px;">Tools and Technologies</a></li>
                        <li class="h5"><a href="#a2" style="color:teal;font-size: 16px;">Steps to Build and Deploy Your Website</a></li>
                    ...
                    <ol>
                      ...
                      <ul>
                        <li><strong>Hosting:</strong> AWS Lightsail</li>
                        <li><strong>Frontend:</strong> Bootstrap 5 Theme (HTML/CSS)</li>

                        <li><strong>Backend:</strong> PHP</li>

                        <li><strong>Web Server:</strong> LAMP or NginX (supports PHP)</li>
                      ...
                      <li id="a2">
                        <h4>Steps to Build and Deploy Your Website</h4>
                        <ol>
                          <li><strong>Set Up AWS Lightsail:</strong></li>
                          <ul>


                            <li>Use <a href="https://computersciencex.com/aws/lamp-server.php" target="_blank" rel="noopener noreferrer" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Guide for setting up AWS LAMP web server" style="color:teal;">AWS Lightsail</a> to host your website. It’s a cost-effective and user-friendly option for beginners.</li>
                            
                          </ul>
                          <li><strong>Choose a Bootstrap 5 Theme:</strong></li>
                          <ul>

                            <li>Select a <a href="https://computersciencex.com/aws/lamp-server.php" target="_blank" rel="noopener noreferrer" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Bootstrap's Theme Library" style="color:teal;">Bootsrap 5 template</a> for your HTML and CSS. This will help you create a responsive and visually appealing frontend.
                            <br><a href="https://themewagon.com/theme-price/free/" target="_blank" rel="noopener noreferrer" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Theme Wagons FREE Bootstrap 5 Templates" style="color:teal;">Theme Wagon have bootstrap 5 templates for FREE</a> if you would like a free alternative.

                            </li>
                          </ul>
                          <li><strong>Develop the Backend with PHP:</strong></li>
                          <ul>
<li><a href="https://computersciencex.com/php/php-1.php" target="_blank" rel="noopener noreferrer" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="5 Pages of PHP & MySQL Tutorials" style="color:teal;">Write your backend code using PHP</a>
  . Ensure your web server (LAMP or NginX) supports PHP to handle server-side operations.
</li>
                          </ul>
                          <li><strong><a href="https://computersciencex.com/php/php-1.php" target="_blank" rel="noopener noreferrer" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Guide for setting up MySQL with MySQL Workbench" style="color:teal;">Set Up a Database (Optional):</a></strong></li>
                          <ul>
                            https://computersciencex.com/php/php-3.php
<li>If you need to store user data, consider setting up an AWS Lightsail database. Note that this service costs at least $30 per month, so it’s advisable only if you have a clear data source.
</li>
                          </ul>
                        </ol>
                      </li>
  ...
  <div class="card mb-4">
    <div class="card-body">
      ...
      <div class="avatar avatar-5xl">
        ...
        <p style="font-size: 13px;" >Date Published <span class="fw-semi-bold text-primary">  <time itemprop="datePublished" datetime="2024-09-03T12:00:00Z">03 Sep 2024</time></span>
          <br>Date Modified <span class="fw-semi-bold text-primary">  <time itemprop="dateModified" datetime="2024-09-03T18:00:00Z">03 Sep 2024</time></span>
