...
$result = mysqli_query($con,"SELECT count FROM likes WHERE ID = 3");
$data = $result->fetch_all(MYSQLI_ASSOC);

$result2 = mysqli_query($con,"SELECT views FROM likes WHERE ID = 3");
$data2 = $result2->fetch_all(MYSQLI_ASSOC);


if(!isset($_COOKIE['not_unique3'])) {
    setcookie('not_unique3', '1', time() + (86400)); //30 days
    ...
    $sql = "UPDATE likes SET views = views + 1 WHERE ID = 3";
...
<html lang="en-US" dir="ltr" data-navigation-type="combo" data-navbar-horizontal-shape="slim">
  ...
  <head>
    ...
    <meta name="description" content="On this page you’ll learn how to seamlessly store data from an HTML form into a MySQL database using PHP">

    <!-- ===============================================-->
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Storing HTML Form Input in a MySQL Database Using PHP | Computer Science X</title>
                        ...
                        <li class="nav-item"><a class="nav-link dropdown-indicator" href="#php-1" data-bs-toggle="collapse" aria-expanded="true" aria-controls="php-1">
                          ...
                          <div class="parent-wrapper">
                            <ul class="nav collapse parent show" data-bs-parent="#php" id="php-1">
                              ...
                              <li class="nav-item"><a class="nav-link active" href="/php/php-2.php">
                ...
                <div class="card-body p-2 p-sm-2 p-lg-3">
                  ...
                  <header>
                    ...
                    <div class="float-end">
                      <nav aria-label="...">
                        ...
                        <ul class="pagination justify-content-center">
                          ...
                          <li class="page-item active" aria-current="page">
                            <a class="page-link" href="/php/php-2.php">2 <span class="sr-only"></span></a>
                          </li>
                      ...
                      <h1 class="display-5">Storing HTML Form Input in a MySQL Database Using PHP</h1>
                      <p class="lead">On this page you’ll learn how to seamlessly store data from an HTML form into a MySQL database using PHP</p>
...
$vemail = $_POST['{ID-OF-HTML-FORM-INPUT(email)}'];
...
$sql = "INSERT INTO subs (firstName, email)
VALUES ('', '{$vemail}')";
...
?&gt;
              ...
              <div class="float-start">          <a href="/php/php-1.php" style="color:teal; font-size: 20px; " class="rounded float-left"><strong>Previous page:</strong> How to gather user input with a HTML email subscription form and store that data in a MySQL Database using PHP</a>
              </div>
              <div class="float-end">          <a href="/php/php-3.php" style="color:teal; font-size: 20px; " class="rounded float-right"><strong>Next page:</strong> How to create an AWS MySQL Database and connect to it via MySQL Workbench</a>
                ...
                <div class="d-none d-lg-block"><!--hide on screens smaller than lg-->
                  ...
                  <nav aria-label="...">
                    <ul class="pagination justify-content-center">
                      <li class="page-item">
                        <a class="page-link" href="/php/php-1.php" tabindex="-1" aria-disabled="true">Previous</a>
                      </li>
                      <li class="page-item"><a class="page-link" href="/php/php-1.php">1</a></li>
                      <li class="page-item active" aria-current="page">
                        <a class="page-link" href="/php/php-2.php">2 <span class="sr-only"></span></a>
                      ...
                      <li class="page-item"><a class="page-link" href="/php/php-5.php">5</a></li>
                      <li class="page-item">
                        <a class="page-link" href="/php/php-3.php">Next</a>
                      </li>
