...
<html lang="en-US" dir="ltr" data-navigation-type="combo" data-navbar-horizontal-shape="slim">
  ...
  <head>
    ...
    <meta name="description" content="In this tutorial, I’ll guide you through building a dynamic webpage with a like button that increments by +1 each time a user clicks it. The button will retrieve data from a MySQL database using PHP">

    <!-- ===============================================-->
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Creating a Dynamic Like Button with PHP and MySQL | Computer Science X</title>
                      ...
                      <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="php">
                        ...
                        <li class="nav-item"><a class="nav-link dropdown-indicator" href="#php-1" data-bs-toggle="collapse" aria-expanded="true" aria-controls="php-1">
                          ...
                          <div class="parent-wrapper">
                            ...
                            <li class="nav-item"><a class="nav-link active" href="/php/php-5.php">
              ...
              <div class="card">
                ...
                <div class="card-body p-2 p-sm-2 p-lg-3">
                  ...
                  <div class="float-end">
                    ...
                    <h1 class="display-5">Creating a Dynamic Like Button with PHP and MySQL</h1>
                    <p class="lead">In this tutorial, I’ll guide you through building a dynamic webpage with a like button that increments by +1 each time a user clicks it. The button will retrieve data from a MySQL database using PHP</p>
            ...
            <div class="float-end">
              ...
              <hr class="hr" />
                    ...
                    <div class="container">
                      ...
                      <ol>
                        <li class="h5"><a href="#a1" style="color:teal;font-size: 16px;">Creating a database and table for page likes using MySQL Workbench</a></li>
                        <li class="h5"><a href="#a2" style="color:teal;font-size: 16px;">Displaying MySQL Database Values with PHP on an HTML Web Page</a></li>
                        <li class="h5"><a href="#a3" style="color:teal;font-size: 16px;">Displaying MySQL Database Values with PHP on an HTML Web Page</a></li>
                        <li class="h5"><a href="#a4" style="color:teal;font-size: 16px;">When HTML button is clicked. Add +1 value to database item for page likes</a></li>
                      </ol>
                    </div>
                    ...
                    <ol>       
                      <br>
                      <li id="a1">
                        <h4>Creating a database and table for page likes using MySQL Workbench:</h4>
                        <ol>
                          <li>Create a Database:</li>
                          <ul>
                            <h3 style="color:#5D8AA8;">Manually:</h3>
                            <li>Open <a href="https://computersciencex.com/php/php-3.php" target="_blank" rel="noopener noreferrer" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Guide for setting up AWS MySQL Database using MySQL Workbench" style="color:teal;">MySQL Workbench</a> and connect to your MySQL server.</li>
                            <li>In the navigator panel, right-click the "schemas" tab.</li>
                            <li>Select "Create Schema."</li>
                            <li>Provide a schema name (e.g., "csx2") and click "Apply" to create the new database.</li>
                            <hr class="hr" />

                            <h4 id="myInput">Creating a database and table for page likes using MySQL Workbench:</h4>

                            <button onclick="myFunction()">Copy text</button>

          
                            <h3 style="color:#5D8AA8;">Using Commands:</h3>
          <pre class="rounded-3 language-sql tabindex=0">
...
<div class="card card-bordered">
    <div class="card-body">
        ...
        <!--end::Row-->
                          ...
                          <ul>
                            <h3 style="color:#5D8AA8;">Manually:</h3>
                            <li>Under the appropriate database in the left navigation pane, right-click "Tables" and select "Create Table..."</li>
                            <li>Enter the table name (e.g., "likes").</li>
                            <li>Add columns: "pageName" and "count" with their respective data types and any other necessary details.</li>
                            <li>Click "Apply" to create the table.</li>
                            <hr class="hr" />
...
USE csx2; SELECT count FROM likes WHERE pageName = 'page1';
                      ...
                      <br>
                      <li  id="a2"><hr class="hr" />
          
          
          <h4>Displaying MySQL Database Values with PHP on an HTML Web Page</h4>
          <p>To display MySQL database values on an HTML web page using PHP, follow these steps:</p>
          <ol>
          <li>Web Server Setup:</li>
          <ul>
          <li>Ensure you are running a web server that supports PHP (e.g., LAMP or NginX).</li>
          </ul>
          <li>File Extension Change:</li>
          <ul>
          <li>Rename your HTML file to have a .php extension instead of .php..</li>
          </ul>
          <li>Embed PHP Code:</li>
          <ul>
          <li>At the top of your PHP-enabled HTML file, add the following code before your HTML content:</li>
          <mark><strong>web-page.php</strong></mark>    
          <pre class="rounded-3 language-bash tabindex=0">
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-filetype-php" viewBox="0 0 16 16">
...
?&gt;
                      ...
                      <br>
                      <li id="a3"><hr class="hr" />
                        <p>You’ll need to loop through each item in the database (even if there’s only one item inserted) to retrieve the data. Since we have only one page, we can simply print the loop, which will display our value for pageLikes.</p>
          
                        <mark><strong>html-file.php</strong></mark>    
          <pre class="rounded-3 language-bash tabindex=0">
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-filetype-php" viewBox="0 0 16 16">
<path fill-rule="evenodd" d="M14 4.5V14a2 2 0 0 1-2 2h-1v-1h1a1 1 0 0 0 1-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5zM1.6 11.85H0v3.999h.791v-1.342h.803q.43 0 .732-.173.305-.175.463-.474a1.4 1.4 0 0 0 .161-.677q0-.375-.158-.677a1.2 1.2 0 0 0-.46-.477q-.3-.18-.732-.179m.545 1.333a.8.8 0 0 1-.085.38.57.57 0 0 1-.238.241.8.8 0 0 1-.375.082H.788V12.48h.66q.327 0 .512.181.185.182.185.522m4.48 2.666V11.85h-.79v1.626H4.153V11.85h-.79v3.999h.79v-1.714h1.682v1.714zm.703-3.999h1.6q.433 0 .732.179.3.175.46.477.158.302.158.677t-.161.677q-.159.299-.463.474a1.45 1.45 0 0 1-.733.173H8.12v1.342h-.791zm2.06 1.714a.8.8 0 0 0 .084-.381q0-.34-.184-.521-.184-.182-.513-.182h-.66v1.406h.66a.8.8 0 0 0 .375-.082.57.57 0 0 0 .237-.24Z"/>
</svg>
...
&lt;/form&gt;
                      ...
                      <br>
                      <li id="a4"><hr class="hr" />
                        <p>Create an <mark>action-page.php</mark> file in the same directory as your web page. Add the code below, ensuring you replace the values with your own.</p>
          
                        <mark><strong>action-page.php</strong></mark>    
<pre class="rounded-3 language-bash tabindex=0">
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-filetype-php" viewBox="0 0 16 16">
<path fill-rule="evenodd" d="M14 4.5V14a2 2 0 0 1-2 2h-1v-1h1a1 1 0 0 0 1-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5zM1.6 11.85H0v3.999h.791v-1.342h.803q.43 0 .732-.173.305-.175.463-.474a1.4 1.4 0 0 0 .161-.677q0-.375-.158-.677a1.2 1.2 0 0 0-.46-.477q-.3-.18-.732-.179m.545 1.333a.8.8 0 0 1-.085.38.57.57 0 0 1-.238.241.8.8 0 0 1-.375.082H.788V12.48h.66q.327 0 .512.181.185.182.185.522m4.48 2.666V11.85h-.79v1.626H4.153V11.85h-.79v3.999h.79v-1.714h1.682v1.714zm.703-3.999h1.6q.433 0 .732.179.3.175.46.477.158.302.158.677t-.161.677q-.159.299-.463.474a1.45 1.45 0 0 1-.733.173H8.12v1.342h-.791zm2.06 1.714a.8.8 0 0 0 .084-.381q0-.34-.184-.521-.184-.182-.513-.182h-.66v1.406h.66a.8.8 0 0 0 .375-.082.57.57 0 0 0 .237-.24Z"/>
</svg>
...
header("Location: https://computersciencex.com/indexSuccess.php", true, 301);  
...
&lt;html lang="en-US">
  ...
  &lt;head&gt
    &lt;title>Example HTML code&lt;/title&gt
  &lt;/head&gt
  &lt;body&gt
    &lt;p>Example&lt;/p&gt
  &lt;/body&gt
&lt;/html&gt
                      ...
                      <small class="d-inline-flex mb-3 px-2 py-1 fw-semibold text-info-emphasis bg-info-subtle border border-info-subtle rounded-2" style="font-size: 18px;">Updated from this point on 10 Jun 25</small>

                      <p><strong>Now that we have created a basic like button, we can make this more secure by using cookies to allow 1 like per user every 30 days. This should prevent people spamming the like button. Another problem we can fix is, when the like button is clicked, the browser goes off the page, runs the php script then returns to the page. We can use AJAX Javascript to allow the php script to be run without leaving the page. We can also add text to tell the user they have successfully added their like to the page.</strong></p>

                      <mark><strong>html-file.php</strong></mark>    
          <pre class="rounded-3 language-javascript tabindex=0">
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-filetype-javascript" viewBox="0 0 16 16">
<path fill-rule="evenodd" d="M14 4.5V14a2 2 0 0 1-2 2h-1v-1h1a1 1 0 0 0 1-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5zM1.6 11.85H0v3.999h.791v-1.342h.803q.43 0 .732-.173.305-.175.463-.474a1.4 1.4 0 0 0 .161-.677q0-.375-.158-.677a1.2 1.2 0 0 0-.46-.477q-.3-.18-.732-.179m.545 1.333a.8.8 0 0 1-.085.38.57.57 0 0 1-.238.241.8.8 0 0 1-.375.082H.788V12.48h.66q.327 0 .512.181.185.182.185.522m4.48 2.666V11.85h-.79v1.626H4.153V11.85h-.79v3.999h.79v-1.714h1.682v1.714zm.703-3.999h1.6q.433 0 .732.179.3.175.46.477.158.302.158.677t-.161.677q-.159.299-.463.474a1.45 1.45 0 0 1-.733.173H8.12v1.342h-.791zm2.06 1.714a.8.8 0 0 0 .084-.381q0-.34-.184-.521-.184-.182-.513-.182h-.66v1.406h.66a.8.8 0 0 0 .375-.082.57.57 0 0 0 .237-.24Z"/>
</svg>
...
&lt;/html&gt
          ...
          <p>As you can see above, when the like button is clicked it runs the "showCustomer()" javascript function(between this script tags). this function then runs the php script without leaving the webpage and also sends a message to the user confirming their like has been successfull</p>

          <p>The php code at the top of the file is loading page likes and views to display and its also </p>


          <hr class="hr" />


<p>Now create an action page php file in the same directory as you web page file. and add the following code bellow:</p>

<mark><strong>action-page.php</strong></mark>    

          <pre class="rounded-3 language-php tabindex=0">
<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-filetype-php" viewBox="0 0 16 16">
<path fill-rule="evenodd" d="M14 4.5V14a2 2 0 0 1-2 2h-1v-1h1a1 1 0 0 0 1-1V4.5h-2A1.5 1.5 0 0 1 9.5 3V1H4a1 1 0 0 0-1 1v9H2V2a2 2 0 0 1 2-2h5.5zM1.6 11.85H0v3.999h.791v-1.342h.803q.43 0 .732-.173.305-.175.463-.474a1.4 1.4 0 0 0 .161-.677q0-.375-.158-.677a1.2 1.2 0 0 0-.46-.477q-.3-.18-.732-.179m.545 1.333a.8.8 0 0 1-.085.38.57.57 0 0 1-.238.241.8.8 0 0 1-.375.082H.788V12.48h.66q.327 0 .512.181.185.182.185.522m4.48 2.666V11.85h-.79v1.626H4.153V11.85h-.79v3.999h.79v-1.714h1.682v1.714zm.703-3.999h1.6q.433 0 .732.179.3.175.46.477.158.302.158.677t-.161.677q-.159.299-.463.474a1.45 1.45 0 0 1-.733.173H8.12v1.342h-.791zm2.06 1.714a.8.8 0 0 0 .084-.381q0-.34-.184-.521-.184-.182-.513-.182h-.66v1.406h.66a.8.8 0 0 0 .375-.082.57.57 0 0 0 .237-.24Z"/>
</svg>
          <code class="language-php">
...
<p>each cookies name needs to be unique for every page. so you will need to create a seperate action-page.php file for every web page that has a like button.</p>
        </li>
                    </ol>
  ...
  <div class="card mb-4">
    <div class="card-body">
      ...
      <div class="avatar avatar-5xl">
        ...
        <p style="font-size: 13px;" >Date Published <span class="fw-semi-bold text-primary">  <time itemprop="datePublished" datetime="2024-06-01T12:00:00Z">01 Jun 2024</time></span>
          <br>Date Modified <span class="fw-semi-bold text-primary">  <time itemprop="dateModified" datetime="2025-06-10T18:00:00Z">10 Jun 2025</time></span>
