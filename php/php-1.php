...
$result = mysqli_query($con,"SELECT count FROM likes WHERE ID = 2");
$data = $result->fetch_all(MYSQLI_ASSOC);

$result2 = mysqli_query($con,"SELECT views FROM likes WHERE ID = 2");
...
if(!isset($_COOKIE['not_unique2'])) {
    ...
    $sql = "UPDATE likes SET views = views + 1 WHERE ID = 2";
