...
$result = mysqli_query($con,"SELECT count FROM likes WHERE ID = 15");
$data = $result->fetch_all(MYSQLI_ASSOC);

$result2 = mysqli_query($con,"SELECT views FROM likes WHERE ID = 15");
$data2 = $result2->fetch_all(MYSQLI_ASSOC);


if(!isset($_COOKIE['not_unique15'])) {
    setcookie('not_unique15', '1', time() + (86400)); //30 days
    ...
    $sql = "UPDATE likes SET views = views + 1 WHERE ID = 15";
...
<html lang="en-US" dir="ltr" data-navigation-type="combo" data-navbar-horizontal-shape="slim">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Custom domain email with Zoho mail | Computer Science X</title>
    ...
    <main class="main" id="top">
          ...
          <div class="navbar-vertical-content">
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
              ...
              <hr class="navbar-vertical-line" />
                ...
                <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator label-1" href="#email" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="email">
                  <div class="d-flex align-items-center">
                    <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-icon"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                ...
                <div class="parent-wrapper label-1">
                  <ul class="nav collapse parent show" data-bs-parent="#navbarVerticalCollapse" id="email">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#email-1" data-bs-toggle="collapse" aria-expanded="true" aria-controls="email-1">
                        <div class="d-flex align-items-center">
                      ...
                      <!-- more inner pages-->
                      <div class="parent-wrapper">
                        <ul class="nav collapse parent show" data-bs-parent="#email" id="email-1">
                          <li class="nav-item"><a class="nav-link active" href="/sys-admin/custom-email.php">
      ...
      <div class="content">
          ...
          <div class="row g-4">
            ...
            <h1 class="display-5">How to set up 1 Free custom domain email with Zoho Mail</h1>
            <p class="lead"></p>
...
<h5 id="GFG"></h5>
                      ...
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/2/sys2-1.png">
    
                      <p>You will need to have purchased your domain name (for example: ComputerScienceX.com). You could maybe try your name and then '.co.uk'(if in UK), if available.</p>
                      <p>I use <a href="https://www.cloudflare.com" target="_blank" rel="noopener noreferrer" style="color:teal;">Cloudflare</a> to purchase my domains. Provides free SSL (HTTPS encryption), gives you analytics (number of unique views, country of IP addresses etc.), DDOS protection with a click of a button and more for free.</p>
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/2/sys2-2.png">
                      <p>When you have bought your domain, you will need to go to the DNS management section.</p>
                      <p>Now go to <a href="https://www.zoho.com/mail/" target="_blank" rel="noopener noreferrer" style="color:teal;">Zoho</a> mail, sign up for a business account and choose your custom domain.
                      </p>
                      <p>You will then need to add what Zoho mail requests you to add to the DNS section of your domain (like shown below):</p>
                      <img class="ratio ratio-16x9" src="/assets/img/sys-admin/2/sys2-3.png">
